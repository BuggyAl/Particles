...
public class ParticleDrippingObsidianTear extends AbstractParticle {

    /**
     * <img src="https://minecraft.wiki/images/Drip_Hang_%28texture%29_JE1_BE1.png" width="50" height="50">
     */

    public ParticleDrippingObsidianTear() {
        this.particleOptions = ParticleTypes.DRIPPING_OBSIDIAN_TEAR;
    }
